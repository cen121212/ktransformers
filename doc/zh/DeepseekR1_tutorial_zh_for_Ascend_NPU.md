...
pip3 install packaging ninja transformers==4.57.1 fire protobuf attrs decorator cloudpickle ml-dtypes scipy tornado absl-py psutil  #此处注意运行时要求的transformers版本要求4.57.1(其他版本未验证）
